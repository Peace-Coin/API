...
module.exports = confirmCode => {
  ...
  let fbPngImage = PcecoinMobileConst.SAVE_URL + 'fb.png';
  let ghPngImage = PcecoinMobileConst.SAVE_URL + 'gh.png';
  let logoPngImage = PcecoinMobileConst.SAVE_URL + 'logo.png';
  let tgPngImage = PcecoinMobileConst.SAVE_URL + 'tg.png';
  let twPngImage = PcecoinMobileConst.SAVE_URL + 'tw.png';
          ...
          <td width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" style="background:#fff;padding:30px;padding-top:60px;padding-bottom:50px">
              ...
              <img src=${logoPngImage} width="180" alt="Peace Coin ICO logo"/>
                    ...
                    <tr>
                      ...
                      Dear Member<br/>
                      An authentication code is issued to change your password.<br/>
                      Please enter the following 5 digit code in the application.<br/>
                      <br/>
                      会員様へ<br/>
                      あなたのパスワード変更用の認証コードを発行しました<br/>
                      以下の５桁のコードをアプリで入力してください
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <div color="#00adbf" style="color:#00adbf;margin:0;word-break: break-all;">
                      ${
                        confirmCode
                      }
                      </div>
