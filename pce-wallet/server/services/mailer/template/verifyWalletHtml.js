...
module.exports = confirmCode => {
  ...
  let url = 'https://wallet-app-dev.peace-coin.org/api/mobile/verify/' + confirmCode;
          ...
          <td width="100%" bgcolor="#fff" border="0" cellpadding="0" cellspacing="0" style="background:#fff;padding:30px;padding-top:60px;padding-bottom:50px">
              ...
              <img src=${logoPngImage} width="180" alt="Peace Coin ICO logo"/>
                    ...
                    <tr>
                      ...
                      Dear Member<br/>
                      Please click the following activation link to complete account registration.<br/>
                      <br/>
                      会員様へ<br/>
                      以下のアクティベーションリンクをクリックしてアカウント登録を完了してください。<br />
                      </td>
                    </tr>
                    <tr>
